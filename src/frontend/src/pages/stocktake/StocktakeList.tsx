...
const StocktakeList: React.FC = () => {
  ...
  const handleStart = (stocktake: Stocktake) => {
    modals.openConfirmModal({
      ...
      children: (
        <Text>
          Are you sure you want to start "{stocktake.name}"? This will begin the counting process.
        </Text>
      ),
  ...
  const handleComplete = (stocktake: Stocktake) => {
    modals.openConfirmModal({
      ...
      children: (
        <Text>
          Are you sure you want to complete "{stocktake.name}"? This will finalize the count and apply adjustments.
        </Text>
      ),
  ...
  const handleCancel = (stocktake: Stocktake) => {
    modals.openConfirmModal({
      ...
      children: (
        <Text>
          Are you sure you want to cancel "{stocktake.name}"? This action cannot be undone.
        </Text>
      ),
  ...
  const handleDelete = (stocktake: Stocktake) => {
    modals.openConfirmModal({
      ...
      children: (
        <Text>
          Are you sure you want to delete "{stocktake.name}"? This action cannot be undone.
        </Text>
      ),
              ...
              <Table.Tbody>
                {stocktakesData?.results.map((stocktake: Stocktake) => (
                  <Table.Tr key={stocktake.id}>
                    <Table.Td>
                      <div>
                        <Text fw={500}>{stocktake.name}</Text>
